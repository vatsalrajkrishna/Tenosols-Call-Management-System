...
$sql="update tblcaller set FirstName=:fname,Phonenumber=:mobileno,Gender=:gender,Address=:address,City=:city where EmailId=:eid";
...
$query->execute();
$msg="Caller record updated Successfully";
}
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Caller | Update Info</title>
...
<?php 
$eid=$_SESSION['emplogin'];
$sql = "SELECT * from  tblcaller where EmailId=:eid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':eid',$eid, PDO::PARAM_STR);
$query->execute();
...
<label for="empcode">Caller Code</label>
