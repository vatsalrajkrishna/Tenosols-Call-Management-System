...
$con="update tblcaller set Password=:newpassword where id=:empid";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Caller | Password Recovery</title>
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">CALLER | Call Management System</span>
                        </div>
                          ...
                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:20px;">Caller details</span>
...
$empid=$_POST['empid'];
$email=$_POST['emailid'];
$sql ="SELECT id FROM tblcaller WHERE EmailId=:email and EmpId=:empid";
