...
$sql="update tbluploader set FirstName=:fname,Phonenumber=:mobileno,Gender=:gender,Address=:address,City=:city where EmailId=:eid";
...
$query->execute();
$msg="Uploader record updated Successfully";
}
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Uploader | Update Info</title>
        
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
        <meta charset="UTF-8">
        <meta name="description" content="Tecnosols Call Management System" />
...
<?php 
$eid=$_SESSION['emplo'];
$sql = "SELECT * from  tbluploader where EmailId=:eid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':eid',$eid, PDO::PARAM_STR);
$query->execute();
...
<label for="empcode">Uploader Code</label>
...
<script>
document.getElementById("stars").innerHTML = getStars(<?php echo htmlentities($result->Rating);?>);
