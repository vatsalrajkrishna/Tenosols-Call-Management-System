...
$username=$_SESSION['emplo'];
    $sql ="SELECT Password FROM tbluploader WHERE EmailId=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tbluploader set Password=:newpassword where EmailId=:username";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Club | Change Password</title>
