...
$sql="update tblcaller set FirstName=:fname,Phonenumber=:mobileno,Rating=:rating where id=:eid";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Update Caller</title>
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Update Caller</div>
                    </div>
...
<?php 
$eid=intval($_GET['empid']);
$sql = "SELECT * from  tblcaller where id=:eid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':eid',$eid, PDO::PARAM_STR);
$query->execute();
...
<label for="empcode">Caller Code(Must be unique)</label>
...
<label for="firstName">Caller Name</label>
...
<input id="phone" name="rating" type="tel" value="<?php echo htmlentities($result->Rating);?>" maxlength="10" autocomplete="off" required>
 </div>
