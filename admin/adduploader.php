...
$status=1;
$rating=0;
$sql="INSERT INTO tbluploader(EmpId,FirstName,EmailId,Password,Gender,Address,City,Phonenumber,Status,Rating) VALUES(:empid,:fname,:email,:password,:gender,:address,:city,:mobileno,:status,:rating)";
...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Add Uploader</div>
                    </div>
