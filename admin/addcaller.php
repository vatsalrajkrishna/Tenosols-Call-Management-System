...
$status=1;
$rating=0;
$sql="INSERT INTO tblcaller(EmpId,FirstName,EmailId,Password,Gender,Address,City,Phonenumber,Status,Rating) VALUES(:empid,:fname,:email,:password,:gender,:address,:city,:mobileno,:status,:rating)";
...
$query->bindParam(':address',$password,PDO::PARAM_STR);
$query->bindParam(':gender',$gender,PDO::PARAM_STR);
...
if($lastInsertId)
{
$msg="Club record added Successfully";
}
else 
{
...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Add Caller</div>
                    </div>
